...
describe('every', () => {
  it('should return true if every element satisfies the condition for numbers', () => {
    const arr = [2, 4, 6, 8];
  ...
  it('should return true if every element satisfies the condition for strings', () => {
    const arr = ['a', 'b', 'c'];
  ...
  it('should return true if every element satisfies the condition for objects', () => {
  ...
  it('should return true if every element satisfies the condition for arrays', () => {
  ...
  it('should return true if every element satisfies the condition for null and undefined', () => {
    const arr = [null, undefined, null, undefined];
    const callBack = (val: null | undefined) =>
      val === null || val === undefined;
    expect(every(arr as (null | undefined)[], callBack)).toBe(true);
  });
  ...
  it('should return false if at least one element does not satisfy the condition for null and undefined', () => {
    ...
    const callBack = (val: null | undefined) =>
      val === null || val === undefined;
    expect(every(arr as (null | undefined)[], callBack)).toBe(false);
  });
});
